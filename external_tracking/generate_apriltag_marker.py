...
def generate_apriltag_set(
    ...
    output_dir = (
        Path("/home/katya/wspace/src/tracking_assets/markers/apriltag")
        / dictionary_label
    )
...
def main() -> None:
    generate_apriltag_set(
        dictionary_name=cv2.aruco.DICT_APRILTAG_36h11,
