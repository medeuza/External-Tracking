...
ROBOTS = [
    ...
    {
        "model_name": "turtlebot3_burger_stag_001",
        "marker_id":  "001",
        "pose":       "1.0   9.0  0.01 0 0 0",
    },
    {
        "model_name": "turtlebot3_burger_stag_002",
        "marker_id":  "002",
        "pose":       "-4.25 9.0  0.01 0 0 0",
    },
    {
        "model_name": "turtlebot3_burger_stag_003",
        "marker_id":  "003",
        "pose":       "-4.25 -9.0 0.01 0 0 0",
    },
    {
        "model_name": "turtlebot3_burger_stag_004",
        "marker_id":  "004",
        "pose":       "1.0   -9.0 0.01 0 0 0",
    },
    {
        "model_name": "turtlebot3_burger_stag_005",
        "marker_id":  "005",
        "pose":       "4   -9.0 0.01 0 0 0",
    },
]
...
def main():
    ...
    print(f"[DONE] All {len(ROBOTS)} STag models generated")
